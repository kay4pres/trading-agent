# Day Trading Basics — Order Entry — Extracted Rules
# Source: Order_Entry_Types.txt
# Date: 2026-06-29
...
### Catalyst News (1 mentions)
- Keywords found: catalyst

## Volume Analysis
- Relative Volume (RV): look for 5x+ above average.
- Volume confirmation required for breakouts.

### Volume Patterns (1 mentions)
- Keywords found: relative volume
...
### Risk Management (3 mentions)
- Keywords found: stop out, max loss, 2:1

## First Pullback Setup
- Entry: first candle making a NEW HIGH after the pullback.
- Skip if pullback >4 candles or >50% retracement.

### First Pullback (5 mentions)
- Keywords found: first pullback, pull back, pullback, resting, setup
...
### Order Types (5 mentions)
- Keywords found: market order, limit order, stop order, trailing stop, fill or kill
...
### Hot Keys (3 mentions)
- Keywords found: hot key, hot keys, SCR
...
### Level2 (7 mentions)
- Keywords found: level 2, time and sales, bid, ask, spread, MM, maker
...
### Market Makers (4 mentions)
- Keywords found: market maker, MM, payment for order flow, direct access

## Position Scaling (Daily)
...
### Trading Platform (4 mentions)
- Keywords found: broker, platform, routing, account
