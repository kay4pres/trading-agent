# Day Trading Basics — Trading Platform — Extracted Rules
# Source: Trading_Platform_Walkthrough.txt
# Date: 2026-06-29
...
### Hot Keys (4 mentions)
- Keywords found: hot key, hot button, scale out, SCR
...
### Scaling (2 mentions)
- Keywords found: scale out, quarter
...
- Keywords found: broker, platform, account, margin
