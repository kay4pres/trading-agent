# Day Trading Basics — Hot Keys & Buttons — Extracted Rules
# Source: Part1_Hot_Keys.txt
# Date: 2026-06-29
...
### Catalyst News (3 mentions)
- Keywords found: catalyst, news catalyst, news catalyst
...
- Keywords found: market order, limit order, stop loss
...
### Hot Keys (4 mentions)
- Keywords found: hot key, hot keys, hot button, SCR
