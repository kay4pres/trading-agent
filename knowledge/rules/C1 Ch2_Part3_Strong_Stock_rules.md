# Day Trading Basics — Stock Picking — Extracted Rules
# Source: Part3_Strong_Stock.txt
# Date: 2026-06-29
...
### Catalyst News (2 mentions)
- Keywords found: catalyst, short squeeze

## Volume Analysis
- Relative Volume (RV): look for 5x+ above average.
- Volume confirmation required for breakouts.

### Volume Patterns (3 mentions)
- Keywords found: relative volume, light volume, RV
...
### First Pullback (4 mentions)
- Keywords found: pull back, pullback, resting, setup
...
### Level2 (7 mentions)
- Keywords found: time and sales, bid, ask, spread, print, MM, maker
...
- Keywords found: market maker, MM, payment for order flow
...
### Stock Types (5 mentions)
- Keywords found: float, low float, small cap, medium float, large cap
...
- Keywords found: broker, account, margin
