# Day Trading Strategies — Risk Management — Extracted Rules
# Source: Learning_Risk_Management.txt
# Date: 2026-06-29
...
- Keywords found: light volume, RV
...
- Keywords found: position sizing, max loss, 2:1
...
### Order Types (2 mentions)
- Keywords found: stop order, bracket
...
### Hot Keys (3 mentions)
- Keywords found: scale out, SCR, reverse
...
### Stock Halts (5 mentions)
- Keywords found: halt, circuit breaker, resume, halted, T2
...
### Level2 (4 mentions)
- Keywords found: bid, ask, spread, MM
...
### Market Makers (3 mentions)
- Keywords found: MM, payment for order flow, direct access
...
### Stock Types (4 mentions)
- Keywords found: float, low float, small cap, large cap
...
### Scaling (4 mentions)
- Keywords found: scale out, position sizing, full size, quarter
...
### Trading Platform (2 mentions)
- Keywords found: broker, account
