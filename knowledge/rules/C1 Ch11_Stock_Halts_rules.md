# Day Trading Basics — Stock Halts — Extracted Rules
# Source: Stock_Halts.txt
# Date: 2026-06-29
...
### Catalyst News (5 mentions)
- Keywords found: catalyst, news catalyst, earnings, short squeeze, news catalyst
...
- Keywords found: pull back, pullback, resting
...
### Order Types (3 mentions)
- Keywords found: market order, limit order, stop order
...
### Stock Halts (9 mentions)
- Keywords found: halt, LULD, circuit breaker, Limit Up, Limit Down, resume, halted, T1, T2
...
### Level2 (5 mentions)
- Keywords found: time and sales, bid, ask, MM, maker
...
- Keywords found: market maker, MM, direct access
...
### Stock Types (3 mentions)
- Keywords found: float, high float, small cap
...
- Keywords found: broker, platform, account
